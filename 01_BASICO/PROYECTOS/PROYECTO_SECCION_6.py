...
interfaz
    ...
    - se solicitara seleccion de opciones
        ...
        * (2) crear receta -> elegir categoria -> crear nombre -> crear contenido
        * (3) crear categoria -> nombre de categoria -> crear carpeta
        * (4) eliminar receta -> elegir categoria -> mostrar recetas -> elegir receta -> elimina receta
        * (5) eliminar categoria -> elegir categoria -> se elimina categoria
        * (6) finalizar programa -> finalizar codigo
        
*** cada ocacion que el usuario realice exitosamente cualquier opcion, el programa debe pedir alguna letra para volver al inicio ()

*** cada ocacion que el usuario vuelva a la pantalla inicial, la consola se debe limpiar
